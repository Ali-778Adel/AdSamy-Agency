...
import 'package:ad_samy/applications/employee-application/employee-features/employee-overview-feature/presentation/pages/tasks-details-test.dart';
import 'package:ad_samy/applications/employee-application/employee-features/employee-overview-feature/presentation/widgets/employee-page-header.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TeamBloc,TeamStates>(
        builder: (context, state) {
          int navIndex=BlocProvider.of<TeamBloc>(context).notificationCycleIndex;
          return WillPopScope(
