class EmployeeTaskDetailsEntity{
  final bool ?status;
  final dynamic message;
  final EmployeeTaskDetailsEntityData?taskDetailsEntityData;
  EmployeeTaskDetailsEntity({this.status,this.message,this.taskDetailsEntityData});
}
class  EmployeeTaskDetailsEntityData{
 final int ?taskId;
