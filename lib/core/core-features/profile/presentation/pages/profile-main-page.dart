...
import '../../../splash_screen/login-options.dart';
import '../profile-bloc/profile-bloc.dart';
import '../profile-bloc/profile-events.dart';
import '../profile-bloc/profile-states.dart';
import '../widgets/profile-field-item.dart';
                  ...
                  return AppBar(
                    ...
                    leading: IconButton(icon: CircleAvatar(
                      ...
                      if(state.userCacheEntity!.user!.type=='client'){
                        ...
                        BlocProvider.of<TeamBloc>(context).add(GetTeamOverViewEvents(wichCycle: WichCycle.homeCycle, teamToken: state.userCacheEntity!.user!.token));
                      }
                    },),
                  );
                }else{
    ...
    return   SafeArea(
        child:  BlocBuilder<ProfileBloc,ProfileStates>(
          builder: (context, state) {
            ...
            return Center(child: Text('no hello '),);
          }
        ));
  }
          ...
          ProfileFieldItem(title: 'Home', leadingIcon: CupertinoIcons.home,onTap:(){
            if(getUserCachedDataState!.userCacheEntity!.user!.type=='client'){
              ...
              BlocProvider.of<TeamBloc>(context).add(GetTeamOverViewEvents(
                  ...
                  teamToken: getUserCachedDataState.userCacheEntity!.user!.token));
            }
          } ,),
