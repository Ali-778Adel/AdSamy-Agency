...
class ProjectPage extends StatelessWidget {
  ...
  Widget _clientInfo({required BuildContext context, List<ProjectAssigned>? map, required String clientName, String? assigned, String? projectMange, String? tag}) {return SizedBox(
      height: CoreDimens.cardH5,
      width: double.infinity,
      child: Padding(
