      ...
      return WillPopScope(
          ...
          onWillPop: (){
            switch(navIndex){
              ...
              case 2:{
                if(BlocProvider.of<TeamBloc>(context).backstack.length==2){
                  BlocProvider.of<TeamBloc>(context).add(PopEvent(context: context));
              ...
              case 3:{
                if(BlocProvider.of<TeamBloc>(context).backstack.length==4||BlocProvider.of<TeamBloc>(context).backstack.length==3){
                  BlocProvider.of<TeamBloc>(context).add(PopEvent(context: context));
                  return BlocProvider.of<TeamBloc>(context).customPop(context).then((value)async{
                    BlocProvider.of<TeamBloc>(context).add(GetTeamProjectTasksEvent(navIndex: 2,projectId: 4));
                    return Future.value(value);
                  });
                }else{
                  BlocProvider.of<TeamBloc>(context).add(PopEvent(context: context));
